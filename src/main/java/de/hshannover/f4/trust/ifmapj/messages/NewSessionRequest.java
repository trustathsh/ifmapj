...
public interface NewSessionRequest extends Request {
	...
	/**
	 * @param maxPollResultSize the max-poll-result-size attribute to be sent
	 *	to the server, or null if not specified.
	 */
	void setMaxPollResultSize(Integer maxPollResultSize);

	/**
	 * @return the max-poll-result-size to be sent to the MAPS, or null if unset.
	 */

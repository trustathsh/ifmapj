...
/**
 * Implement by delegating to {@link SearchHolderImpl}.
 *
 * @author aw
 *
 */
class SearchRequestImpl extends RequestImpl implements SearchRequest {


	private final SearchHolder mSearchHolder;

	SearchRequestImpl(SearchHolder searchHolder) {

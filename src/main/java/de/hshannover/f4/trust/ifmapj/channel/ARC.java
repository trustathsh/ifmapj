...
public interface ARC extends IfmapChannel {
	...
	/**
	 * Send a poll on the ARC. This is a blocking method that returns when the
	 * poll results from the MAPS have been received.
	 *
	 * @return the poll results that have been received from the MAPS

...
/**
 * Possible values for the enforcement-action element within an
 * enforcement-report.
 * 
 * @author ib
 *
...
public enum EnforcementAction {
	block { public String toString() { return "block"; } },
	quarantine { public String toString() { return "quarantine"; } },
